...
YEAR <-  "2021"                         # School Year (Ending,2016-present). No 2020 due to COVID
...
COUNTIEStxt <- c('Nassau')    # County.  Must match shareddata, don't capitalize 
...
# Make Plot, 
fig <- plot_ly(shared_data, x = ~L3.L4_PCT, y = ~NAME, type = 'bar', orientation = 'h', name = '% Proficient', width = 950, height = nrow(shared_data)*22, 
  ...
  # set axis and plot display
      layout(barmode = 'stack',
              ...
              title = list(text='<i><b>\n>95% of ALL People Are Capable of Reading</i></b>', font = t1, x = 0.8, y= 98)  # yanchor = 'top'
             ) %>% 
...
#Nassau contains 56 districts, and Suffolk 68 = 124 (includes charters? I'm getting 100)
