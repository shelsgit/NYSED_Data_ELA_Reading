...
output_file <- "C:/Users/srene/Documents/NY LITERACY REPORT CARD website -local/NYSourceDATA/SOURCE_DATA/SOURCEDATA_ALLDistrictsGrades-ELLCohortsIncluded.csv"
...
data_2021 <- data_2021 %>% 
  ...
  filter(SUBGROUP_CODE ==  1 | SUBGROUP_CODE ==  11 | SUBGROUP_CODE ==  15 | SUBGROUP_CODE ==  6 | SUBGROUP_CODE ==  12 | SUBGROUP_CODE ==  13)
...
data_ALL <- data_ALL[!duplicated(data_ALL[c("SY_END_DATE","COUNTY_DESC", "BEDSCODE", "NAME", "ITEM_DESC", "SUBGROUP_CODE")]),]
